...
from companyspider.useragents import useragents
...
class CompanyspiderSpiderMiddleware(object):
...
class CompanyspiderDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
